...
class MENDQADataset:
    ...
    def __init__(self, data_dir: Union[List[Dict], str, Path], tok: AutoTokenizer, size=10000, ans_trigger = ANS_TRIGGER, *args, **kwargs):
...
class MendTrainDataset(object):
    def __init__(
        ...
        self.data, self.idx_maps = self.get_prefix_example(raw, stats)
        self._reset_()
    ...
    def get_prefix_example(self, raw, stats = None):
        ...
        return data, (index_map, index_map_inv)